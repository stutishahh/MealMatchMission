...
<body>
    ...
    <section class="dashboard">
        ...
        <div class="top">
            ...
            <!-- <p>Food Donate</p> -->
            <p  class ="logo" ><b style="color: #185519; ">Meal Match Mission</b></p>
             <p class="user"></p>
...
var xplace=["alkapuri","makarpura","manjalpur"];
var yplace=[<?php echo json_encode($alkapuri,JSON_HEX_TAG);?>,<?php echo json_encode($makarpura,JSON_HEX_TAG);?>,<?php echo json_encode($manjalpur,JSON_HEX_TAG);?>];
var yValues = [<?php echo json_encode($male,JSON_HEX_TAG);?>,<?php echo json_encode($female,JSON_HEX_TAG);?>,30];
var barColors = ["#185519","blue"];
var bar=["#185519","blue","red"]
